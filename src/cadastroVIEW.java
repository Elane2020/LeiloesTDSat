...
public class cadastroVIEW extends javax.swing.JFrame {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        if (nome.trim().isEmpty() || valor.trim().isEmpty()){
            JOptionPane.showMessageDialog(this, "Preencha o nome e o valor do produto antes de cadastrar.", "Atenção",
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "O valor informado deve ser um número válido.", "Erro", 
                    JOptionPane.ERROR_MESSAGE);
        }
