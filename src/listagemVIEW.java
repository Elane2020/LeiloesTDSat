...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(245, 243, 255));
        ...
        btnVender.setBackground(new java.awt.Color(203, 229, 255));
        ...
        btnVendas.setBackground(new java.awt.Color(220, 250, 227));
    ...
    int itemSelecionado = listaProdutos.getSelectedRow();
    if (itemSelecionado == -1) {
        JOptionPane.showMessageDialog(null, "Selecione um produto para vender.");
        return;
    }
  
    ProdutosDTO produto = listagem.get(itemSelecionado);
    ...
    boolean sucesso = produtosdao.venderProduto(produto.getId());

    if (sucesso) {
        JOptionPane.showMessageDialog(this, "Produto vendido com sucesso!", "Sucesso",
                JOptionPane.INFORMATION_MESSAGE);
    } else {
        JOptionPane.showMessageDialog(this, "Não foi possível vender o produto.", "Erro",
  ...
  //      vendas.requestFocus();
    ...
    public void formatarTabela() {
        ...
        listaProdutos.getTableHeader().setBackground(Color.lightGray);
        listaProdutos.setSelectionBackground(Color.PINK);
        listaProdutos.setFillsViewportHeight(true);
        listaProdutos.setShowHorizontalLines(false);
        listaProdutos.setShowVerticalLines(false);
     
        DefaultTableCellRenderer centralizado = new DefaultTableCellRenderer();
        centralizado.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);

    for (int i = 0; i < listaProdutos.getColumnCount(); i++) {
        listaProdutos.getColumnModel().getColumn(i).setCellRenderer(centralizado);
    }
